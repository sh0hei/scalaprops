...
object StreamTTest extends Scalaprops {
  ...
  val tailMRec = {
    ...
    def test[F[_]: Monad: BindRec](implicit
      ...
      Try(s.tailM).toOption === Try(s.tailMRec).toOption
    }
  ...
  val foldLeftRec = {
    ...
    def test[F[_]: Monad: BindRec](implicit
      ...
      s.foldLeft(z)(f) === s.foldLeftRec(z)(f)
    }
